...
public class ReportUI {
     ...
     * Filter interface
     * 
     * @param filteredList Filtered list of camps
     * @param originalList List of camps
     * @param filtered Boolean value indicating if the list filtered before
     * @return List of camps that are filtered if they are filtered, otherwise return original list
     */
